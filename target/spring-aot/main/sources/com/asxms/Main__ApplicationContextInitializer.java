 ...
 */
@Generated
public class Main__ApplicationContextInitializer implements ApplicationContextInitializer<GenericApplicationContext> {
  @Override
  public void initialize(GenericApplicationContext applicationContext) {
    ...
    new Main__BeanFactoryRegistrations().registerBeanDefinitions(beanFactory);
    new Main__BeanFactoryRegistrations().registerAliases(beanFactory);
  }
