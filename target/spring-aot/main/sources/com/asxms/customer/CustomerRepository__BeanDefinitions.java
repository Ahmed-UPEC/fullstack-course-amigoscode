...
public class CustomerRepository__BeanDefinitions {
  ...
  public static BeanDefinition getCustomerRepositoryBeanDefinition() {
    ...
    beanDefinition.setTargetType(ResolvableType.forClassWithGenerics(JpaRepositoryFactoryBean.class, CustomerRepository.class, Object.class, Object.class));
    beanDefinition.setLazyInit(false);
    beanDefinition.getConstructorArgumentValues().addIndexedArgumentValue(0, "com.asxms.customer.CustomerRepository");
